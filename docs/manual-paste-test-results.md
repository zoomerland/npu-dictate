...
| B8 | Tab switching/current target | Not covered | No tab-switching evidence in the provided page log. |
...
- Re-check B8 when testing tab/window switching in real apps.
